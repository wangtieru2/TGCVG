...
from src.transformer.elucidated_transformer import ElucidatedTransformer
...
def split_transformer_trajectory(
        samples: Union[np.ndarray, torch.Tensor],
        env: gym.Env,
...
def construct_transformer_model(
        ...
        act_dim,
        max_action,
        obs_normalizer: BaseNormalizer,
        edm_config,
) -> ElucidatedTransformer:
    return ElucidatedTransformer(
